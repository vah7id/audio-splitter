...
const CustomInput = ({ accept, onFiles, files, disabled }: IInputProps): JSX.Element | null => {
  ...
  return files.length > 0 ? null : (
    <div className="text-center p-3">
     <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#222" class="bi bi-upload" viewBox="0 0 16 16">
      <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
      <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
    </svg>
      <p className=" align-items-center justify-content-start" style={{opacity: 0.5, marginTop: '18px'}}>
      ...
      <p style={{opacity: 0.3, marginTop: '-12px', fontSize: '12px'}}>Supported Formats: {ALLOWED_EXTENSIONS.sort().join(', ')}</p>
