...
class DynamicMixModal extends React.Component<Props, State> {
  ...
  render(): JSX.Element | null {
    ...
    return (
      <Modal size="sm" centered show={show} onHide={!isCreating ? this.onHide : undefined} onExited={this.onExited}>
        ...
        <Modal.Footer>
          ...
          <Button variant="warning" onClick={this.onSubmit} disabled={invalidAlpha || isCreating}>
            Create Mix
          </Button>
        </Modal.Footer>
      </Modal>
