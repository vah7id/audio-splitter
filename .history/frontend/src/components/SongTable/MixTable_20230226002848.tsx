...
const modelFormatter: ColumnFormatter<MixItem> = (cellContent, row) => {
  ...
  const badge = (
    <Badge variant="dark" style={shouldShowTooltip ? { cursor: 'pointer' } : {}}>
      Processed via {separatorLabelMap[separator]} 
    </Badge>
  );
    ...
    const columns: ColumnDescription[] = [
      {
        ...
        headerStyle: () => {
          return { width: '40px', paddingLeft: '20px', fontSize: '20px' };
        },
        style: () => {
          return { width: '40px', paddingLeft: '20px', fontSize: '20px' };
        },
      ...
      },*/
      {
        ...
        style: () => {
          return { maxWidth: '100px', paddingRight: 2, float: 'right', marginRight: 8 };
        },
      },
    ];
