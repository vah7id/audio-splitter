...
const spleetColFormatter: ColumnFormatter<SongData> = (cell, row, rowIndex, formatExtraData) => {
  ...
  return (
    <div className="d-flex align-items-center justify-content-end">
      <TextButton style={{paddingLeft: '12px !important'}} className="pl-1" variant="warning" disabled={disabled} onClick={onDynamicMixClick} song={row}>
         <Layers className="align-middle" size={16} />
        <span className="align-middle"> Seperate Layouts</span>
      </TextButton>
      <TextButton style={{paddingLeft: '12px !important'}} className="pl-1" variant="dark" disabled={disabled} onClick={onStaticMixClick} song={row}>
         <Scissors className="align-middle" size={16} />
