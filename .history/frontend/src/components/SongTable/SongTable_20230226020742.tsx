...
class SongTable extends React.Component<Props> {
  ...
  componentDidUpdate(prevProps, prevState) {
    const fntmp = async() => {
      ...
      if((prevProps.data && prevProps.data.length === 0 && this.props.data && this.props.data.length > 0 && this.props.data.url && this.props.data?.url.indexOf('media/uploads') > -1) || 
        (prevProps.data && prevProps.data.length === 0 &&  this.props.data.length > 0 &&  this.props.data && this.props.data[0].url) ||
       (prevProps.data.length > 0 && prevProps.data[0]?.url !== "" && this.props.data && this.props.data[0] && prevProps.data[0].url !== this.props.data[0].url) ) {
        if(el) {
          el.forEach((ch, index) => {
            if(ch) {
              ch.click();
