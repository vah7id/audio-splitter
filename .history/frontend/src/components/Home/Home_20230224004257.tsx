      ...
      <div>
        <div className="jumbotron jumbotron-fluid bg-transparent">
          <div className="container secondary-color" style={{maxWidth: '920px'}}>
            <div class style={{width: '100%', display: 'block', textAlign: 'center'}}>
              <h2 className="display-5">Vocal Remover and Layout Seperation</h2>
              <p style={{maxWidth: '620px',margin: '0 auto 24px auto', fontSize: '1rem'}} className="lead">Separate vocal, accompaniment, bass, and/or drum components of any song using powerful AI algorithms and yes its FREE!!</p>
              <Button onClick={this.onUploadClick} variant="success mr-3">
                Upload My Audio File<CloudUpload />
              </Button>
            </div>
           
            {task && (
              <Alert style={{fontSize: '24px !important'}} variant="success">
                <span>
