...
const CustomInput = ({ accept, onFiles, files, disabled }: IInputProps): JSX.Element | null => {
  ...
  return files.length > 0 ? null : (
    <div className="text-center p-3">
      <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#aaa" class="bi bi-file-earmark-arrow-up" viewBox="0 0 16 16">
      <path d="M8.5 11.5a.5.5 0 0 1-1 0V7.707L6.354 8.854a.5.5 0 1 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 7.707V11.5z"/>
      <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z"/>
    </svg>
      <p className="d-flex align-items-center justify-content-start" style={{opacity: 0.3, marginTop: '24px'}}>
