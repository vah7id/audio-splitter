...
const CustomInput = ({ accept, onFiles, files, disabled }: IInputProps): JSX.Element | null => {
  ...
  const supportedFormatsTooltip = (props: OverlayInjectedProps) => {
    ...
    return (
      <Tooltip id="status-tooltip" {...props}>
        {text} <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" class="bi bi-file-earmark-arrow-up" viewBox="0 0 16 16">
  ...
  <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
      ...
      <p className="d-flex align-items-center justify-content-start" style={{opacity: 0.3, marginTop: '18px'}}>
