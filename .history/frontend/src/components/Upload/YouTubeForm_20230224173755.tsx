        ...
        <Form.Group as={Col} controlId="formGridFirst">
          <InputGroup>
            <Form.Control
              ...
              disabled={disabled}
              defaultValue={value}
              placeholder="https://www.youtube.com/watch?v= or Type your song title"
              onChange={handleChange}
            />
            <InputGroup.Append style={{background: 'red', width: '60px', height: '60px', color: 'black'}} className="justify-content-center align-items-center">{trailingIcon}</InputGroup.Append>
          </InputGroup>
        </Form.Group>
      </Form.Row>
