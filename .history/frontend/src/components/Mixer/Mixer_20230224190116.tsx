...
class Mixer extends React.Component<RouteComponentProps<MatchParams>, State> {
  ...
  render(): JSX.Element | null {
    ...
    return (
      <div style={{textAling: 'center !important', marginTop: '32px'}}>
        <Container style={{textAling: 'center !important', marginTop: '24px'}}>
          <h2 className="mt-3">Vocal Remover and Audio Splitter AI</h2>
