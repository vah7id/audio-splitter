...
import { Alert, Badge, Container, Row, Spinner, Nav } from 'react-bootstrap';
    ...
    return (
      <div style={{ alignItems: 'center', alignContent: 'center', marginTop: '32px'}}>
        <Container style={{ alignItems: 'center', alignContent: 'center', marginTop: '24px'}}>
          <h2 className="mt-3 center">Vocal Remover and Audio Splitter AI</h2>
         <p style={{maxWidth: '620px',margin: '0 auto 32px auto', fontSize: '1rem'}} className="lead center">Separate vocal, accompaniment, bass, and/or drum components of any song using powerful AI algorithms and yes its FREE!!</p>
